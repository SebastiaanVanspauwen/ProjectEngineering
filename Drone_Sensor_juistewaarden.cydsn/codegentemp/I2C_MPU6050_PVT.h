...
#define I2C_MPU6050_GetI2CExtClkInterruptSourceMasked()          (I2C_MPU6050_INTR_I2C_EC_MASKED_REG)
    ...
    #define I2C_MPU6050_SetSpiExtClkInterruptMode(interruptMask) \
                                                                I2C_MPU6050_WRITE_INTR_SPI_EC_MASK(interruptMask)
    #define I2C_MPU6050_ClearSpiExtClkInterruptSource(interruptMask) \
                                                                I2C_MPU6050_CLEAR_INTR_SPI_EC(interruptMask)
    ...
    extern void I2C_MPU6050_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask);
...
extern I2C_MPU6050_BACKUP_STRUCT I2C_MPU6050_backup;
    ...
    extern uint16 I2C_MPU6050_IntrTxMask;
