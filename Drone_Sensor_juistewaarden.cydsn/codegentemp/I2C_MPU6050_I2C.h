...
#define I2C_MPU6050_I2C_SLAVE_ADDRESS          (0x8u)
#define I2C_MPU6050_I2C_SLAVE_ADDRESS_MASK     (0xFEu)
#define I2C_MPU6050_I2C_ACCEPT_ADDRESS         (0u)
#define I2C_MPU6050_I2C_ACCEPT_GENERAL_CALL    (0u)
...
#define I2C_MPU6050_I2C_MODE_MULTI_MASTER_MASK  (0x04u)
    ...
    #define I2C_MPU6050_CHECK_I2C_GENERAL_CALL \
                (0u != (I2C_MPU6050_I2C_CTRL_REG & I2C_MPU6050_I2C_CTRL_S_GENERAL_IGNORE))

    #define I2C_MPU6050_I2C_WAKE_ENABLE_CONST              (1u)
    #define I2C_MPU6050_I2C_SLAVE_CONST                    (1u)
    #define I2C_MPU6050_I2C_MASTER_CONST                   (1u)
    #define I2C_MPU6050_I2C_MULTI_MASTER_SLAVE_CONST       (1u)
    #define I2C_MPU6050_CHECK_I2C_ACCEPT_ADDRESS_CONST     (1u)
    #define I2C_MPU6050_CHECK_I2C_GENERAL_CALL_CONST       (1u)
    #define I2C_MPU6050_I2C_CUSTOM_ADDRESS_HANDLER_CONST   (1u)

    /* Returns FIFO size */
    #if (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
        #define I2C_MPU6050_I2C_FIFO_SIZE      (I2C_MPU6050_FIFO_SIZE)
    #else
        #define I2C_MPU6050_I2C_FIFO_SIZE      (I2C_MPU6050_GET_FIFO_SIZE(I2C_MPU6050_CTRL_REG & \
                                                                                    I2C_MPU6050_CTRL_BYTE_MODE))
    ...
    #define I2C_MPU6050_CHECK_I2C_GENERAL_CALL     (0u != I2C_MPU6050_I2C_ACCEPT_GENERAL_CALL)
    ...
    #define I2C_MPU6050_I2C_MULTI_MASTER_SLAVE_CONST   (I2C_MPU6050_I2C_MULTI_MASTER_SLAVE)
    #define I2C_MPU6050_CHECK_I2C_ACCEPT_ADDRESS_CONST (I2C_MPU6050_CHECK_I2C_ACCEPT_ADDRESS)
    #define I2C_MPU6050_CHECK_I2C_GENERAL_CALL_CONST   (I2C_MPU6050_CHECK_I2C_GENERAL_CALL)
    #define I2C_MPU6050_I2C_CUSTOM_ADDRESS_HANDLER_CONST   (I2C_MPU6050_CHECK_I2C_ACCEPT_ADDRESS_CONST || \
                                                                  I2C_MPU6050_CHECK_I2C_GENERAL_CALL_CONST)

    /* I2C: TX or RX FIFO size */
    #define I2C_MPU6050_I2C_FIFO_SIZE  I2C_MPU6050_GET_FIFO_SIZE(I2C_MPU6050_I2C_BYTE_MODE_ENABLE)

    /* Adjust AF and DF filter settings. Ticket ID#176179 */
    #if ((I2C_MPU6050_I2C_MODE_SLAVE == I2C_MPU6050_I2C_MODE) ||     \
            ((I2C_MPU6050_I2C_MODE_SLAVE != I2C_MPU6050_I2C_MODE) && \
             (I2C_MPU6050_I2C_DATA_RATE_ACTUAL <= I2C_MPU6050_I2C_DATA_RATE_FS_MODE_MAX)))

        #define I2C_MPU6050_I2C_MEDIAN_FILTER_ENABLE_ADJ       (0u)
        #define I2C_MPU6050_I2C_CFG_ANALOG_FITER_ENABLE_ADJ    do{;}while(0)
    #else
        #define I2C_MPU6050_I2C_MEDIAN_FILTER_ENABLE_ADJ       (1u)
        #define I2C_MPU6050_I2C_CFG_ANALOG_FITER_ENABLE_ADJ    I2C_MPU6050_I2C_CFG_ANALOG_FITER_DISABLE
    #endif

    /* Select oversampling factor low and high */
    #define I2C_MPU6050_I2C_OVS_FACTOR_LOW_MIN     ((0u != I2C_MPU6050_I2C_MANUAL_OVS_CONTROL) ? \
                                                            (8u) : (8u))

    #define I2C_MPU6050_I2C_OVS_FACTOR_HIGH_MIN    ((0u != I2C_MPU6050_I2C_MANUAL_OVS_CONTROL) ? \
                                                            (8u) : (8u))

#endif /* (I2C_MPU6050_SCB_MODE_UNCONFIG_CONST_CFG) */

#define I2C_MPU6050_I2C_CUSTOM_ADDRESS_HANDLER (I2C_MPU6050_CHECK_I2C_GENERAL_CALL || \
                                                     I2C_MPU6050_CHECK_I2C_ACCEPT_ADDRESS)
...
typedef struct
{
     ...
     *  - I2C_MPU6050_I2C_MODE_SLAVE
     *  - I2C_MPU6050_I2C_MODE_MASTER
     *  - I2C_MPU6050_I2C_MODE_MULTI_MASTER
     *  - I2C_MPU6050_I2C_MODE_MULTI_MASTER_SLAVE
    */
    uint32 mode;
...
* @{
*/
#if (I2C_MPU6050_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
    void I2C_MPU6050_SetI2cAddressCustomInterruptHandler(uint32 (*func) (void));
#endif /* (I2C_MPU6050_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
/** @} interrupt */
...
#define I2C_MPU6050_I2C_ACK_ADDR           (0u)    /* Send ACK to address */
#define I2C_MPU6050_I2C_NAK_ADDR           (1u)    /* Send NAK to address */
#define I2C_MPU6050_I2C_ACK_DATA           (0u)    /* Send ACK to data */
#define I2C_MPU6050_I2C_NAK_DATA           (1u)    /* Send NAK to data */
...
#define I2C_MPU6050_I2C_MSTR_ERR_ARB_LOST      (0x01u)  /* Master lost arbitration: INTR_MASTER_I2C_ARB_LOST     */
...
#define I2C_MPU6050_I2C_MSTR_ERR_BUS_ERR       (0x100u) /* Bus error has: INTR_MASTER_I2C_BUS_ERROR              */
#define I2C_MPU6050_I2C_MSTR_ERR_TIMEOUT       (I2C_MPU6050_I2C_MASTER_TIMEOUT) /* Operation timeout        */
...
#define I2C_MPU6050_I2C_SSTAT_RD_OVFL          (0x04u)    /* Read overflow: master reads above buffer size */
...
#define I2C_MPU6050_I2C_SSTAT_WR_OVFL          (0x40u)    /* Write overflow: master writes above buffer size */
...
#define I2C_MPU6050_I2C_TX_OVERFLOW_COUNT      (I2C_MPU6050_I2C_FIFO_SIZE + 2u)
...
#define I2C_MPU6050_I2C_FSM_SL_WR          (0x11u) /* Slave write states */
#define I2C_MPU6050_I2C_FSM_SL_RD          (0x12u) /* Slave read  states */
...
#define I2C_MPU6050_CHECK_I2C_FSM_RD   (0u != (I2C_MPU6050_I2C_FSM_MSTR_RD  & I2C_MPU6050_state))
...
/* Returns TRUE if sourceMask is set in I2C_MPU6050_I2C_MASTER_CMD_REG: used to check if Start was generated */
#define I2C_MPU6050_CHECK_I2C_MASTER_CMD(sourceMask)   (0u != (I2C_MPU6050_I2C_MASTER_CMD_REG & (sourceMask)))

/* Returns TRUE if I2C_MPU6050_MODE_NO_STOP is set in I2C_MPU6050_mstrControl: detects NoStop condition */
#define I2C_MPU6050_CHECK_I2C_MODE_NO_STOP(mode)   (0u != (I2C_MPU6050_I2C_MODE_NO_STOP & (mode)))

/* Returns TRUE if I2C_MPU6050_MODE_REPEAT_START is set: used to detect when generate ReStart condition */
#define I2C_MPU6050_CHECK_I2C_MODE_RESTART(mode)   (0u != (I2C_MPU6050_I2C_MODE_REPEAT_START  & (mode)))

/* Returns TRUE if I2C_MPU6050_state is in one of master states */
...
#define I2C_MPU6050_I2C_MASTER_TIMEOUT_POS (31u)
#define I2C_MPU6050_I2C_MASTER_TIMEOUT     ((uint32) 0x01u << I2C_MPU6050_I2C_MASTER_TIMEOUT_POS)

/* Slave address match or general call */
#define I2C_MPU6050_SLAVE_INTR_I2C_ADDR    (I2C_MPU6050_INTR_SLAVE_I2C_ADDR_MATCH | \
                                                 I2C_MPU6050_INTR_SLAVE_I2C_GENERAL)

/* Send byte condition: used by */
#define I2C_MPU6050_INTR_MASTER_SEND_BYTE   (I2C_MPU6050_INTR_MASTER_I2C_ACK      | \
                                                  I2C_MPU6050_INTR_MASTER_I2C_NACK     | \
                                                  I2C_MPU6050_INTR_MASTER_I2C_ARB_LOST | \
                                                  I2C_MPU6050_INTR_MASTER_I2C_BUS_ERROR)
/* Receive byte error conditions */
#define I2C_MPU6050_INTR_MASTER_RECEIVE_BYTE   (I2C_MPU6050_INTR_MASTER_I2C_ARB_LOST | \
                                                     I2C_MPU6050_INTR_MASTER_I2C_BUS_ERROR)
/* Stop condition */
#define I2C_MPU6050_INTR_MASTER_SEND_STOP  (I2C_MPU6050_INTR_MASTER_I2C_STOP     | \
                                                 I2C_MPU6050_INTR_MASTER_I2C_ARB_LOST | \
                                                 I2C_MPU6050_INTR_MASTER_I2C_BUS_ERROR)
...
#define I2C_MPU6050_I2C_RX_CTRL    ((I2C_MPU6050_ONE_BYTE_WIDTH - 1u) | \
                                          I2C_MPU6050_RX_CTRL_MSB_FIRST    | \
                                          I2C_MPU6050_RX_CTRL_ENABLED)

#define I2C_MPU6050_I2C_TX_CTRL    ((I2C_MPU6050_ONE_BYTE_WIDTH - 1u) | \
...
#define I2C_MPU6050_I2C_PHASE_GEN_TIMEOUT      (20000u)

#define I2C_MPU6050_I2C_IGNORE_GENERAL_CALL    ((uint32) (0u == I2C_MPU6050_I2C_ACCEPT_GENERAL_CALL))

/* Convert the timeout in milliseconds to microseconds */
#define I2C_MPU6050_I2C_CONVERT_TIMEOUT_TO_US(timeoutMs)   ((timeoutMs) * 1000u)
...
***************************************/
        ...
        #define I2C_MPU6050_I2C_WAKE_ENABLE_ADJ    (I2C_MPU6050_I2C_MULTI_MASTER_SLAVE ? \
                                                            (0u) : (I2C_MPU6050_I2C_WAKE_ENABLE))
    #else
        #define I2C_MPU6050_I2C_WAKE_ENABLE_ADJ    (I2C_MPU6050_I2C_WAKE_ENABLE)
    ...
    #define I2C_MPU6050_I2C_DEFAULT_CTRL \
                                (I2C_MPU6050_GET_CTRL_BYTE_MODE  (I2C_MPU6050_I2C_BYTE_MODE_ENABLE) | \
                                 I2C_MPU6050_GET_CTRL_ADDR_ACCEPT(I2C_MPU6050_I2C_ACCEPT_ADDRESS)   | \
                                 I2C_MPU6050_GET_CTRL_EC_AM_MODE (I2C_MPU6050_I2C_WAKE_ENABLE_ADJ))

    #define I2C_MPU6050_I2C_DEFAULT_I2C_CTRL \
                    (I2C_MPU6050_GET_I2C_CTRL_HIGH_PHASE_OVS(I2C_MPU6050_I2C_OVS_FACTOR_HIGH_MIN)   | \
                     I2C_MPU6050_GET_I2C_CTRL_LOW_PHASE_OVS (I2C_MPU6050_I2C_OVS_FACTOR_LOW_MIN)    | \
                     I2C_MPU6050_GET_I2C_CTRL_S_GENERAL_IGNORE(I2C_MPU6050_I2C_IGNORE_GENERAL_CALL) | \
    ...
    #define I2C_MPU6050_I2C_DEFAULT_RX_CTRL \
                                (I2C_MPU6050_GET_RX_CTRL_MEDIAN(I2C_MPU6050_I2C_MEDIAN_FILTER_ENABLE_ADJ) | \
    ...
    #define I2C_MPU6050_I2C_DEFAULT_INTR_SLAVE_MASK    ((I2C_MPU6050_I2C_SLAVE) ? \
                (I2C_MPU6050_I2C_INTR_SLAVE_MASK | \
                 I2C_MPU6050_GET_INTR_SLAVE_I2C_GENERAL(I2C_MPU6050_I2C_ACCEPT_GENERAL_CALL)) : (0u))

    #define I2C_MPU6050_I2C_DEFAULT_INTR_MASTER_MASK   (I2C_MPU6050_NO_INTR_SOURCES)
