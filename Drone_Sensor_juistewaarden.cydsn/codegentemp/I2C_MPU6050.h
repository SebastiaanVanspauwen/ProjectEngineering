...
#define I2C_MPU6050_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)

/** Component version major.minor */
#define I2C_MPU6050_COMP_VERSION_MAJOR    (4)
#define I2C_MPU6050_COMP_VERSION_MINOR    (0)
...
#if (I2C_MPU6050_SCB_CLK_INTERNAL)
    #include "I2C_MPU6050_SCBCLK.h"
#endif /* (I2C_MPU6050_SCB_CLK_INTERNAL) */
...
*/
    ...
    void I2C_MPU6050_SetCustomInterruptHandler(void (*func)(void));
...
/* Interface to internal interrupt component */
    ...
    */    
    /*******************************************************************************
    * Function Name: I2C_MPU6050_EnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: I2C_MPU6050_DisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: I2C_MPU6050_ClearPendingInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: I2C_MPU6050_RxWakeEnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: I2C_MPU6050_RxWakeDisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: I2C_MPU6050_RxWakeClearPendingInt
    ****************************************************************************//**
    *
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: I2C_MPU6050_GetInterruptCause
****************************************************************************//**
*
...
*    - I2C_MPU6050_INTR_CAUSE_MASTER - Interrupt from Master
*    - I2C_MPU6050_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - I2C_MPU6050_INTR_CAUSE_TX - Interrupt from TX
*    - I2C_MPU6050_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetRxInterruptSource
****************************************************************************//**
*
...
*   - I2C_MPU6050_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - I2C_MPU6050_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - I2C_MPU6050_INTR_RX_FULL - Receiver FIFO is full.
*   - I2C_MPU6050_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - I2C_MPU6050_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - I2C_MPU6050_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - I2C_MPU6050_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetRxInterruptMode
****************************************************************************//**
*
...
*   I2C_MPU6050_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - I2C_MPU6050_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - I2C_MPU6050_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - I2C_MPU6050_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to I2C_MPU6050_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
#define I2C_MPU6050_SetRxInterrupt(interruptMask)  I2C_MPU6050_SET_INTR_RX(interruptMask)

void I2C_MPU6050_SetRxFifoLevel(uint32 level);


/* APIs to service INTR_TX register */
/*******************************************************************************
* Function Name: I2C_MPU6050_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - I2C_MPU6050_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - I2C_MPU6050_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - I2C_MPU6050_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - I2C_MPU6050_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - I2C_MPU6050_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - I2C_MPU6050_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - I2C_MPU6050_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - I2C_MPU6050_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetTxInterruptMode
****************************************************************************//**
*
...
*   I2C_MPU6050_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - I2C_MPU6050_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - I2C_MPU6050_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - I2C_MPU6050_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - I2C_MPU6050_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
void I2C_MPU6050_SetTxFifoLevel(uint32 level);


/* APIs to service INTR_MASTER register */
/*******************************************************************************
* Function Name: I2C_MPU6050_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - I2C_MPU6050_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - I2C_MPU6050_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - I2C_MPU6050_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - I2C_MPU6050_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - I2C_MPU6050_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - I2C_MPU6050_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetMasterInterruptMode
****************************************************************************//**
*
...
*   I2C_MPU6050_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define I2C_MPU6050_SetMasterInterruptMode(interruptMask)  I2C_MPU6050_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: I2C_MPU6050_GetMasterInterruptMode
****************************************************************************//**
*
...
*   I2C_MPU6050_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define I2C_MPU6050_GetMasterInterruptMode()   (I2C_MPU6050_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: I2C_MPU6050_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to I2C_MPU6050_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - I2C_MPU6050_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - I2C_MPU6050_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - I2C_MPU6050_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - I2C_MPU6050_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - I2C_MPU6050_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - I2C_MPU6050_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - I2C_MPU6050_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - I2C_MPU6050_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - I2C_MPU6050_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - I2C_MPU6050_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   I2C_MPU6050_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define I2C_MPU6050_SetSlaveInterruptMode(interruptMask)   I2C_MPU6050_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: I2C_MPU6050_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   I2C_MPU6050_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define I2C_MPU6050_GetSlaveInterruptSourceMasked()    (I2C_MPU6050_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: I2C_MPU6050_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_MPU6050_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to I2C_MPU6050_GetSlaveInterruptSource() 
...
/** I2C_MPU6050_initVar indicates whether the I2C_MPU6050 
*  component has been initialized. The variable is initialized to 0 
*  and set to 1 the first time SCB_Start() is called. This allows 
*  the component to restart without reinitialization after the first 
*  call to the I2C_MPU6050_Start() routine.
*
*  If re-initialization of the component is required, then the 
*  I2C_MPU6050_Init() function can be called before the 
*  I2C_MPU6050_Start() or I2C_MPU6050_Enable() function.
*/
...
#define I2C_MPU6050_STATUS_PTR             ( (reg32 *) I2C_MPU6050_SCB__STATUS)
    ...
    #define I2C_MPU6050_UART_TX_CTRL_PTR       ( (reg32 *) I2C_MPU6050_SCB__UART_TX_CTRL)
    ...
    #define I2C_MPU6050_UART_FLOW_CTRL_REG     (*(reg32 *) I2C_MPU6050_SCB__UART_FLOW_CTRL)
    #define I2C_MPU6050_UART_FLOW_CTRL_PTR     ( (reg32 *) I2C_MPU6050_SCB__UART_FLOW_CTRL)
...
#ifdef I2C_MPU6050_SCB__EZ_DATA0
    #define I2C_MPU6050_EZBUF_DATA0_REG    (*(reg32 *) I2C_MPU6050_SCB__EZ_DATA0)
    #define I2C_MPU6050_EZBUF_DATA0_PTR    ( (reg32 *) I2C_MPU6050_SCB__EZ_DATA0)
#else
    #define I2C_MPU6050_EZBUF_DATA0_REG    (*(reg32 *) I2C_MPU6050_SCB__EZ_DATA00)
    #define I2C_MPU6050_EZBUF_DATA0_PTR    ( (reg32 *) I2C_MPU6050_SCB__EZ_DATA00)
#endif /* I2C_MPU6050_SCB__EZ_DATA00 */
...
#define I2C_MPU6050_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define I2C_MPU6050_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define I2C_MPU6050_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define I2C_MPU6050_FF_DATA_NR_LOG2_MASK       (0x07u)      /* Number of bits to represent a FIFO address. */
#define I2C_MPU6050_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* Number of bits to represent #bytes in FIFO. */
...
#if !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
#define I2C_MPU6050_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define I2C_MPU6050_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#if !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_CTRL_BYTE_MODE ((uint32) 0x01u << I2C_MPU6050_CTRL_BYTE_MODE_POS)
#endif /* !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
...
#define I2C_MPU6050_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define I2C_MPU6050_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define I2C_MPU6050_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define I2C_MPU6050_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
#define I2C_MPU6050_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#if !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL1_POLARITY_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL2_POLARITY_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << I2C_MPU6050_SPI_CTRL_SSEL3_POLARITY_POS)
    #define I2C_MPU6050_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
...
#define I2C_MPU6050_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
...
#define I2C_MPU6050_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define I2C_MPU6050_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define I2C_MPU6050_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define I2C_MPU6050_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define I2C_MPU6050_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    /* I2C_MPU6050_UART_FLOW_CTRL_REG */
    #define I2C_MPU6050_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define I2C_MPU6050_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define I2C_MPU6050_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define I2C_MPU6050_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define I2C_MPU6050_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK)
    #define I2C_MPU6050_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       I2C_MPU6050_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define I2C_MPU6050_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       I2C_MPU6050_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define I2C_MPU6050_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       I2C_MPU6050_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */

/* I2C_MPU6050_I2C_CTRL */
#define I2C_MPU6050_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define I2C_MPU6050_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define I2C_MPU6050_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define I2C_MPU6050_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define I2C_MPU6050_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define I2C_MPU6050_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define I2C_MPU6050_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
...
#else
#define I2C_MPU6050_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define I2C_MPU6050_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define I2C_MPU6050_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define I2C_MPU6050_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define I2C_MPU6050_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define I2C_MPU6050_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << I2C_MPU6050_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define I2C_MPU6050_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            I2C_MPU6050_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define I2C_MPU6050_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << I2C_MPU6050_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            I2C_MPU6050_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            I2C_MPU6050_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            I2C_MPU6050_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define I2C_MPU6050_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            I2C_MPU6050_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (I2C_MPU6050_CY_SCBIP_V0) */


/* I2C_MPU6050_TX_CTRL_REG */
#define I2C_MPU6050_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define I2C_MPU6050_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define I2C_MPU6050_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define I2C_MPU6050_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK)
...
#define I2C_MPU6050_TX_FIFO_STATUS_USED_MASK   ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_PLUS1_MASK)
#define I2C_MPU6050_TX_FIFO_SR_VALID           ((uint32) 0x01u << I2C_MPU6050_TX_FIFO_SR_VALID_POS)
#define I2C_MPU6050_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK << \
                                                                    I2C_MPU6050_TX_FIFO_STATUS_RD_PTR_POS)
#define I2C_MPU6050_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK << \
                                                                    I2C_MPU6050_TX_FIFO_STATUS_WR_PTR_POS)
...
#define I2C_MPU6050_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define I2C_MPU6050_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define I2C_MPU6050_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define I2C_MPU6050_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK)
...
#define I2C_MPU6050_RX_FIFO_STATUS_USED_MASK   ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_PLUS1_MASK)
#define I2C_MPU6050_RX_FIFO_SR_VALID           ((uint32) 0x01u << I2C_MPU6050_RX_FIFO_SR_VALID_POS)
#define I2C_MPU6050_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK << \
                                                                    I2C_MPU6050_RX_FIFO_STATUS_RD_PTR_POS)
#define I2C_MPU6050_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) I2C_MPU6050_FF_DATA_NR_LOG2_MASK << \
                                                                    I2C_MPU6050_RX_FIFO_STATUS_WR_PTR_POS)
...
#define I2C_MPU6050_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
...
#define I2C_MPU6050_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define I2C_MPU6050_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define I2C_MPU6050_INTR_TX_FIFO_LEVEL         (I2C_MPU6050_INTR_TX_TRIGGER)
...
#define I2C_MPU6050_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
...
#define I2C_MPU6050_INTR_RX_FIFO_LEVEL         (I2C_MPU6050_INTR_RX_TRIGGER)
...
*/
#define I2C_MPU6050_SCB_SW_RESET   I2C_MPU6050_I2CFwBlockReset()
...
/* Return true if sourceMask is set in I2C_MPU6050_CTRL_REG: generally is used to check enable bit */
...
#define I2C_MPU6050_DISABLE_AUTO_DATA \
                do{                        \
                    I2C_MPU6050_I2C_CTRL_REG &= ((uint32) ~(I2C_MPU6050_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 I2C_MPU6050_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 I2C_MPU6050_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 I2C_MPU6050_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define I2C_MPU6050_I2C_SLAVE_GENERATE_ACK \
    ...
    void I2C_MPU6050_I2CSlaveNackGeneration(void);
    #define I2C_MPU6050_I2C_SLAVE_GENERATE_NACK I2C_MPU6050_I2CSlaveNackGeneration()
...
#define I2C_MPU6050_DIGITAL_FILTER_DISABLE    (0u)
#define I2C_MPU6050_DIGITAL_FILTER_ENABLE     (1u)
#define I2C_MPU6050_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (I2C_MPU6050_CY_SCBIP_V0)
    /* I2C_MPU6050_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define I2C_MPU6050_I2C_CFG_FILT_MASK  (I2C_MPU6050_I2C_CFG_SDA_FILT_ENABLED | \
                                                 I2C_MPU6050_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* I2C_MPU6050_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define I2C_MPU6050_I2C_CFG_FILT_MASK  (I2C_MPU6050_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 I2C_MPU6050_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (I2C_MPU6050_CY_SCBIP_V0) */

#define I2C_MPU6050_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            I2C_MPU6050_I2C_CFG_REG &= (uint32) ~I2C_MPU6050_I2C_CFG_FILT_MASK; \
        }while(0)

#define I2C_MPU6050_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            I2C_MPU6050_I2C_CFG_REG |= (uint32)  I2C_MPU6050_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return FIFO size depends on I2C_MPU6050_CTRL_BYTE_MODE bit */
#define I2C_MPU6050_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * I2C_MPU6050_FIFO_SIZE) : (I2C_MPU6050_FIFO_SIZE))
...
#if (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define I2C_MPU6050_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (I2C_MPU6050_CTRL_BYTE_MODE) : (0u))
#endif /* (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
...
#define I2C_MPU6050_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)  ((((uint32) (oversampleLow) - 1u) << \
                                                                    I2C_MPU6050_I2C_CTRL_LOW_PHASE_OVS_POS) &  \
...
#define I2C_MPU6050_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (I2C_MPU6050_I2C_CTRL_S_GENERAL_IGNORE) : (0u))

#define I2C_MPU6050_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << I2C_MPU6050_I2C_CTRL_SLAVE_MODE_POS)
...
#define I2C_MPU6050_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define I2C_MPU6050_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define I2C_MPU6050_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (I2C_MPU6050_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define I2C_MPU6050_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     I2C_MPU6050_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */

#define I2C_MPU6050_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << I2C_MPU6050_SPI_CTRL_MODE_POS) & \
                                                                                 I2C_MPU6050_SPI_CTRL_MODE_MASK)

#define I2C_MPU6050_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) (select) << \
                                                                      I2C_MPU6050_SPI_CTRL_SLAVE_SELECT_POS) & \
                                                                      I2C_MPU6050_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* I2C_MPU6050_UART_CTRL */
#define I2C_MPU6050_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
#define I2C_MPU6050_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    I2C_MPU6050_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    I2C_MPU6050_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
/* I2C_MPU6050_UART_FLOW_CTRL */
#if !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
    #define I2C_MPU6050_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 I2C_MPU6050_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define I2C_MPU6050_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (I2C_MPU6050_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define I2C_MPU6050_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (I2C_MPU6050_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define I2C_MPU6050_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (I2C_MPU6050_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1) */
...
#define I2C_MPU6050_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
#define I2C_MPU6050_GET_TX_CTRL_DATA_WIDTH(dataWidth)  (((uint32) (dataWidth) - 1u) & \
                                                                I2C_MPU6050_TX_CTRL_DATA_WIDTH_MASK)
...
/* I2C_MPU6050_INTR_SLAVE_I2C_GENERAL */
#define I2C_MPU6050_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (I2C_MPU6050_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled I2C_MPU6050_SPI_CTRL_REG */
#define I2C_MPU6050_CHECK_SPI_MASTER   (0u != (I2C_MPU6050_SPI_CTRL_REG & I2C_MPU6050_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define I2C_MPU6050_GET_SPI_SCLK_INACTIVE \
            ((0u == (I2C_MPU6050_SPI_CTRL_REG & I2C_MPU6050_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (I2C_MPU6050_CY_SCBIP_V0 || I2C_MPU6050_CY_SCBIP_V1)
#define I2C_MPU6050_GET_SPI_SS0_INACTIVE       (1u)
#define I2C_MPU6050_GET_SPI_SS1_INACTIVE       (1u)
#define I2C_MPU6050_GET_SPI_SS2_INACTIVE       (1u)
#define I2C_MPU6050_GET_SPI_SS3_INACTIVE       (1u)
#define I2C_MPU6050_GET_UART_RTS_INACTIVE      (1u)

#else
#define I2C_MPU6050_GET_SPI_SS0_INACTIVE  \
        ((0u != (I2C_MPU6050_SPI_CTRL_REG & I2C_MPU6050_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define I2C_MPU6050_GET_SPI_SS1_INACTIVE  \
        ((0u != (I2C_MPU6050_SPI_CTRL_REG & I2C_MPU6050_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define I2C_MPU6050_GET_SPI_SS2_INACTIVE  \
        ((0u != (I2C_MPU6050_SPI_CTRL_REG & I2C_MPU6050_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define I2C_MPU6050_GET_SPI_SS3_INACTIVE  \
        ((0u != (I2C_MPU6050_SPI_CTRL_REG & I2C_MPU6050_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define I2C_MPU6050_GET_UART_RTS_INACTIVE \
        ((0u == (I2C_MPU6050_UART_FLOW_CTRL_REG & I2C_MPU6050_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define I2C_MPU6050_CY_SCBIP_V1_I2C_ONLY   (I2C_MPU6050_CY_SCBIP_V1)
#define I2C_MPU6050_EZBUFFER_SIZE          (I2C_MPU6050_EZ_DATA_NR)

#define I2C_MPU6050_EZBUF_DATA00_REG   I2C_MPU6050_EZBUF_DATA0_REG
#define I2C_MPU6050_EZBUF_DATA00_PTR   I2C_MPU6050_EZBUF_DATA0_PTR
