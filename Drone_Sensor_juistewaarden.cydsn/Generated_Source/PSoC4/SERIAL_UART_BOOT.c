...
/*******************************************************************************
* Function Name: SERIAL_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SERIAL_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SERIAL_UartCyBtldrCommReset
****************************************************************************//**
*
...
void SERIAL_UartCyBtldrCommReset(void)
{
    ...
    SERIAL_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: SERIAL_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != SERIAL_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = SERIAL_SpiUartGetRxBufferSize();
                    CyDelayUs(SERIAL_UART_BYTE_TO_BYTE);
                }
                while (byteCount != SERIAL_SpiUartGetRxBufferSize());

                byteCount = SERIAL_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) SERIAL_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: SERIAL_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus SERIAL_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        SERIAL_SpiUartPutArray(pData, (uint32) size);
